  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="w-100 px-3" id="register-form" name="register-form" method="POST" action="admins/insert">
          ...
          <div class="modal-footer pt-1">
            ...
            <button type="submit" class="btn btn-primary" name="registeradmin">Create</button>
          </div>
        </form>
      </div>
